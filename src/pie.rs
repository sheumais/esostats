use std::rc::Rc;
use charming::{Chart, WasmRenderer, component::{Legend, LegendType}, element::{Color, ItemStyle, JsFunction, Label, LabelLine, Orient, TextStyle, Tooltip, Trigger}, series::Pie};
use yew::prelude::*;
...
pub fn pie_chart(props: &PieChartProps) -> Html {
    ...
    let name = if partitions.len() == 1 {
        ...
        "Top 75 Most Used Skills (All Recorded Patches)".to_string()
    };
        ...
        let chart = Chart::new()
            ...
            .series(
                Pie::new()
                    ...
                    .item_style(ItemStyle::new().border_color("#282c38").border_width(3).border_radius(5))
                    .data(chart_data),
            );
...
pub fn pie_chart(props: &PieChartProps) -> Html {
    ...
    let name = if partitions.len() == 1 {
        ...
        "Top 50 Most Used Sets (All Recorded Patches)".to_string()
    };
